...
SECRET_KEY = os.getenv(
	"DJANGO_SECRET_KEY",
	"django-insecure-o*j8%z1mr+$ki#j+w16h+b7+*vwu(^8-zaxvjm51a2wlrxf%sx",
)
...
ALLOWED_HOSTS: list[str] = [host for host in _allowed_hosts.split(";") if host] if _allowed_hosts else []
...
# Add web directory to static files
STATICFILES_DIRS = [
    BASE_DIR.parent / "web",
]
